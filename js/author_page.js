...
function author_page_init(page) {
  ...
  const footerMsg =
    '✦ The <highlight>Authors</highlight> listed here contain expandable and arranged alphabetically songs and prayers, making it easier to find a song when you know who composed or is traditionally associated with it. Traditional bhajans for which no author is known are grouped under <i>Anonymous Vaiṣṇava</i>.';
